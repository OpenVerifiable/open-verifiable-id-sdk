...
describe('SchemaManager', () => {
  ...
  describe('deleteSchema', () => {
    ...
    it('should successfully delete an existing schema', async () => {
      await expect(
        schemaManager.deleteSchema(testSchema.id, 'did:key:test-author')
    ...
    it('should throw error for non-existent schema', async () => {
      await expect(
        schemaManager.deleteSchema('non-existent', 'did:key:test-author')
      ).rejects.toThrow('Schema not found');
    });

    it('should throw error for unauthorized deletion', async () => {
      await expect(
        schemaManager.deleteSchema(testSchema.id, 'did:key:other-author')
